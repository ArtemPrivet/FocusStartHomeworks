...
final class DetailsCharacterViewController: UIViewController
{
	...
	private func setupViews() {
		...
		descriptionLabel.text = selectedCharacter.description.isEmpty ? "No info" : selectedCharacter.description
...
extension DetailsCharacterViewController: UITableViewDataSource, UITableViewDelegate
{
	...
	func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		let cell = comicsTableView.dequeueReusableCell(withIdentifier: "comicsCell") ??
