...
protocol IDetailsAuthorViewController: AnyObject
{
	func updateData()
}

final class DetailsAuthorViewController: UIViewController
{
	...
	private func setupViews() {
		...
		lastNameLabel.text = selectedAuthor.lastName.isEmpty ? "No info" : selectedAuthor.lastName
...
extension DetailsAuthorViewController: UITableViewDataSource, UITableViewDelegate
{
	...
	func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		let cell = comicsesTableView.dequeueReusableCell(withIdentifier: "comicsCell") ??
			UITableViewCell(style: .default, reuseIdentifier: "comicsCell")
