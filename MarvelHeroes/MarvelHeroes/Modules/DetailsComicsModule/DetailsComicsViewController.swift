...
protocol IDetailsComicsViewController: AnyObject
{
	func updateData()
}

final class DetailsComicsViewController: UIViewController
{
	...
	private func setupViews() {
		...
		if let description = selectedComics.description {
			descriptionLabel.text = description.isEmpty ? "No info" : description
		}
...
extension DetailsComicsViewController: UITableViewDataSource, UITableViewDelegate
{
	...
	func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		let cell = charactersTableView.dequeueReusableCell(withIdentifier: "characterCell") ??
			UITableViewCell(style: .default, reuseIdentifier: "characterCell")
